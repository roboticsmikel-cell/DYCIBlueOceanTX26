...
export default function Canvas3D({ artifact, onBack, onViewData, onStream }) {
  ...
  return (
    <div className="grid h-screen w-full gap-4 p-4 grid-cols-1 grid-rows-4 md:grid-cols-2 md:grid-rows-2 bg-black text-white">
      ...
      {/* BOTTOM RIGHT */}
      <div className="relative flex min-h-0 flex-col rounded-xl border border-cyan-500 overflow-auto">
        ...
        <button
          onClick={onViewData}
          className="absolute bottom-4 right-4 z-10 rounded border border-cyan-300 px-3 py-1 text-cyan-300 bg-black/70 backdrop-blur"
        >
          View Data
        </button>
